      ...
      <div className='forex-page-section'>
          ...
          <div className='about-section copy-trade-section'>
            <div className="about-wrapper copy-trade-wrapper about-copy-trade-section forex-copy-trade-section">
              <div className="about-page-img forex-img-container">
                <img src="/mirrorstatmockup6.png" className='forex-img' data-aos="fade-up" alt="commodities" />
              </div>
              <div className="tesla-widget-text-container" data-aos="fade-up">
                <h1>Commodities <span className="highlight">trading</span></h1>
                <p>Trade the world's most essential raw materials — from gold and silver to crude oil, natural gas, and agricultural products. Commodities offer diversification and a reliable hedge against inflation. At Saxo Managements, our traders analyse supply-demand dynamics and macro trends to capture high-probability opportunities across global commodity markets.</p>
        ...
        <section className='trading-view-forex-section' data-aos="fade-up">
          <div className="videoframe-text-container">
            <h1><span className="highlight">Commodities</span> screener</h1>
          </div>
          <div className="trading-view-forex-wrapper">
            <div className="trading-view-card">
              <div className="trading-view-card-text-container">
                ...
                <p>Screen and filter commodities markets by key technical and fundamental indicators to identify the best opportunities.</p>
              </div>
              <Stockscreener />
            </div>
          </div>
