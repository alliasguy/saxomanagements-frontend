            ...
            }
      {
        ...
        <div className="login-wrapper">
          <form class="form"  onSubmit={(e)=>{
            ...
            <span className="login-logo" style={{fontWeight:'700', fontSize:'1.2rem', letterSpacing:'1px', color:'inherit'}}>Saxo Managements</span>
          <div class="title_container">
            <p class="titles">welcome admin</p>
             <span class="subtitle">Saxo Managements admin panel — manage users, traders, and withdrawals.</span>
          </div>
          <br/>
