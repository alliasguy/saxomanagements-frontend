  ...
  return (
      <div className='why-choose-section'>
          <div className="why-choose-us-img-container">
              ...
              <img src="/saxomockup4.png" alt="" className="mockup" data-aos="fade-up"/>
          </div>
          ...
          <div className="why-choose-us-card-container">
            ...
            <h1 data-aos="fade-up">Saxo Managements</h1>
            <p data-aos="fade-up">Here are some of our core platform features built to support your investment journey.</p>
            </div>
